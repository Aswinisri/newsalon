...
if(isset($_POST['book'])){
   ...
   if($total_rooms >= 30){
      ...
      if($verify_bookings->rowCount() > 0){
         ...
         $book_room = $conn->prepare("INSERT INTO `bookings`(booking_id, user_id, name, email, number, rooms, check_in, persons) VALUES(?,?,?,?,?,?,?,?)");
         $book_room->execute([$booking_id, $user_id, $name, $email, $number, $rooms, $check_in, $persons]);
